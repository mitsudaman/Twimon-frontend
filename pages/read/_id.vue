      ...
      <template v-else>
        ...
        <v-row>
          <v-dialog
            ...
            <v-card>
              ...
              <v-card-title class="title font-weight-bold pt-0">{{user.name}}のひみつ</v-card-title>
              <v-card-text>
                <p v-if="user.url1">
        ...
        <v-row
          ...
          <v-col cols="11" md="10">
            ...
            <v-row v-else>
              <v-col class="pb-1 pl-1 font-weight-bold">
                <span class="talk_name px-3 py-1">{{user.name}}</span>
              </v-col>
              <v-col
                class="balloon_area font-weight-bold"
                @click="talkNext"
                cols="12"
                >
                <p class="text-xs-left">{{talkSentence}}</p>
                <p class="next-arrow mb-0">▼</p>
              </v-col>
            </v-row>
          </v-col>
        </v-row>
